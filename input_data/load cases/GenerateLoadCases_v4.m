...
function [load_case,load_series] = GenerateLoadCases_v4(data)
...
load_case(1).duration = hours(17);  %intermittent load duration - updated to be an even hour
...
load_case(2).duration = hours(5);  %intermittent load duration - updated to be an even hour
load_case(2).L_intermittent = ((1000/5)+90)/0.75; %intermittent load [W] - updated to have the same energy

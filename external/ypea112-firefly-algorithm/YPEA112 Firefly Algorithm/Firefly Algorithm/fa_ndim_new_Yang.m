...
n=25;                   % Population size (number of fireflies)
alpha=0.8;              % Randomness strength 0--1 (highly random)
beta0=2.0;              % Attractiveness constant
gamma=3;                % Absorption coefficient
theta=0.98;             % Randomness reduction factor theta=10^(-5/tMax) 
delta = 0.05;
...
for k=1:tMax,        
    ...
    scale=delta.*abs(Ub-Lb);      % Scale of the optimization problem

...
fs = 10; %font size
figure
set(gcf,'Unit','Inches','OuterPosition',[0.3,0.3,3,3])
tf = tiledlayout(2,2);
tf.Padding = 'compact';
tf.TileSpacing = 'compact';
%tf.InnerPosition = [0.25,0.16,0.7,0.72];

ax(1) = nexttile;
hold on
plot(kW_dies,DiesTot./1000,'linewidth',2,'DisplayName','Diesel','color',colpm(4,:))
plot(kW_inso,SolarTot./1000,'linewidth',2,'DisplayName','Solar','color',colpm(2,:))
plot(kW_wind,WindTot./1000,'linewidth',2,'DisplayName','Wind','color',colpm(1,:))
plot(kW_wave,WaveTot./1000,'linewidth',2,'DisplayName','Wave','color',colpm(3,:))
plot(kW_curr,CurrTot./1000,'linewidth',2,'DisplayName','Current','color',colpm(5,:))
grid on
box on
set(gca,"TickLabelInterpreter",'latex','FontSize',fs)
%xlabel('Generator Rated Power [kW]','Interpreter','latex','FontSize',fs)
%ylabel({'Subsystem',' Cost',' [\$1000]'},'Interpreter','latex','FontSize',fs,'Rotation',0,'VerticalAlignment','middle','Units','Normalized','Position',[-.47 .5 -1]) %
...
ax(2) = nexttile;
plot(Smax,BattTot./1000,'linewidth',2,'DisplayName','Battery','color',colb(1,:))
grid on
box on
set(gca,"TickLabelInterpreter",'latex','FontSize',fs)
%xlabel('Battery max capacity [kWh]','Interpreter','latex','FontSize',fs)
...
ax(3) = nexttile;
hold on
plot(kW_dies,DiesMass,'linewidth',2,'color',colpm(4,:))
plot(kW_inso,SolarMass,'linewidth',2,'color',colpm(2,:))
plot(kW_wind,WindMass,'linewidth',2,'color',colpm(1,:))
plot(kW_wave,WaveMass,'linewidth',2,'color',colpm(3,:))
plot(kW_curr,CurrMass,'linewidth',2,'color',colpm(5,:))
grid on
box on
set(gca,"TickLabelInterpreter",'latex','FontSize',fs)
xlabel('$G_r$ [kW]','Interpreter','latex','FontSize',fs)
%ylabel({'Subsystem',' Mass',' [kg]'},'Interpreter','latex','FontSize',fs,'Rotation',0,'VerticalAlignment','middle','Units','Normalized','Position',[-.47 .5 -1]) %
...
ax(4) = nexttile;
plot(Smax,BattMass,'linewidth',2,'color',colb(1,:))
grid on
box on
set(gca,"TickLabelInterpreter",'latex','FontSize',fs)
xlabel('$S_{max}$ [kWh]','Interpreter','latex','FontSize',fs)

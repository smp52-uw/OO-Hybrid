...
coln = brewermap(9,'PuRd');
colw = brewermap(9,'YlGn');
colo = brewermap(9,'YlOrRd');

col = [colb(6,:); colm(7,:); coln(6,:); colw(7,:); colo(5,:)];
%col = colormap(brewermap(l,'Set2')); %colors
ms = 9; %marker size
mlw = .5; %marker line width
fs = 6; %font size
fs2 = 8; %map font size
fs3 = 9; %annotation font size
lw = 1.2; %line width

...
hold on
plot(datetime(Kwave{2}(1:end-1,1),'ConvertFrom','datenum'), ...
    Kwave{2}(1:end-1,2)/1000,'Color',col(2,:), ...
...
% set(ylh,'Rotation',0,'Units','Normalized','Position',[-.225 .75 -1], ...
%     'VerticalAlignment','middle', ...
%     'HorizontalAlignment','center')
...
% text(-.225,.25,'$$\mathrm{\bigg[\frac{kW}{m}\bigg]}$$', ...
%     'Units','Normalized','Interpreter','latex', ...
%     'VerticalAlignment','middle','FontWeight','normal', ...
%     'HorizontalAlignment','center','FontSize',fs);
% ylim([0 inf])
...
hold on
plot(datetime(Kwind{2}(1:end-1,1),'ConvertFrom','datenum'), ...
    Kwind{2}(1:end-1,2)/1000,'Color',col(3,:), ...
    'LineWidth',lw,'LineStyle',':')
%xl = xlabel('Time');
% xtickformat(['MM']);
...
%     'VerticalAlignment','middle', ...
%     'HorizontalAlignment','center')
% text(-.225,.25,'$$\mathrm{\bigg[\frac{kW}{m^2}\bigg]}$$', ...
%     'Units','Normalized','Interpreter','latex', ...
%     'VerticalAlignment','middle','FontWeight','normal', ...
%     'HorizontalAlignment','center','FontSize',fs);
% ylim([0 inf])
...
hold on
plot(datetime(Ksolar{2}(1:end-1,1),'ConvertFrom','datenum'), ...
    Ksolar{2}(1:end-1,2)/1000,'Color',col(5,:), ...
    'LineWidth',lw,'LineStyle',':')
%xl = xlabel('Time');
% xtickformat('MM');

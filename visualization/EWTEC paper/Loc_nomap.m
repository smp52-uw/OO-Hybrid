...
set(gcf,'Color','w')
col = colormap(brewermap(6,'Pastel1')); %colors
...
%hL = legend('show','Location','northwest','box','off','Units','Inches')
%set(hL,'Interpreter','latex')
%hLPos = get(hL,'Position');
%set(hL,'Position',[hLPos(1) hLPos(2)+0.05 hLPos(3) hLPos(4)+0.025])
xl = xlabel('Time');
set(xl,'Interpreter','latex')
xtickformat('yyyy');

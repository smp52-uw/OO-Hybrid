...
set(gca,'Position',[1.25,0.45,4.75,1.5])
%add arrow
ax = gca;
ax.Units = 'normalized';
x_arr = 3;
...
legend([a(1,2) a(2,2) a(3,2) ...
    ...
    'B = 5 m','B = 6 m','Location','northeast','box','off')
grid on
set(gca,'FontSize',fs,'LineWidth',lw2)

print(wscwr,'~/Dropbox (MREL)/Research/OO-TechEc/paper_figures/wscwr', '-dpng','-r600')
